...
import {ApartmentShort} from "../../../../types";
import theme from "../../../../theme";
import {cardStyle, fullCardStyle} from "../../../../styles";

interface Props {
  apartment: ApartmentShort;
  isFull?: boolean;
}

const ApartmentCard: React.FC<Props> = ({ apartment, isFull }) => {
  ...
  const openCard = () => {
    void navigate(`/apartments/${apartment._id}`);
  };
